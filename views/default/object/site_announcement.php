...
//AGUS sobrescribe la vista del plugin site_announcements para cambiar el estilo del anuncio eliminando una de las clases (ver comentario más adelante)
...
if ($full_view) {
	...
	// AGUS $class = "elgg-message elgg-state-notice";
